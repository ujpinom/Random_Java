...
public class TextUnweightedGraphInducedSubgraph {
	...
	public static void main(String[] args) {
		...
		UnweightedGraphInducedSubgraph<String> grafo= new UnweightedGraphInducedSubgraph<>(cities,edges);
		
		
		grafo.grafoInducido(grafo, 3);
		
		if(grafo.getSize()==0) {
			System.out.println("No existe tal grafo");
		}
		else {
			grafo.printEdges();
		}
