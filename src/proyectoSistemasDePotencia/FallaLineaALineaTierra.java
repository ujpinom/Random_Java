...
public class FallaLineaALineaTierra {
	...
	public void corrientesPuntoFalla() {
		...
		try {
			...
			double impedanciTotal= matrizImpedanciaZ1[indexBarraFallada-1][indexBarraFallada-1]+((matrizImpedanciaZ2[indexBarraFallada-1][indexBarraFallada-1]*(matrizImpedanciaZ0[indexBarraFallada-1][indexBarraFallada-1]+
					3*barraFallada.getImpedanciaFalla()))/(matrizImpedanciaZ2[indexBarraFallada-1][indexBarraFallada-1]+matrizImpedanciaZ0[indexBarraFallada-1][indexBarraFallada-1]+3*barraFallada.getImpedanciaFalla()));
			...
			impedanciTotal=matrizImpedanciaZ2[indexBarraFallada-1][indexBarraFallada-1]/(matrizImpedanciaZ2[indexBarraFallada-1][indexBarraFallada-1]+matrizImpedanciaZ0[indexBarraFallada-1][indexBarraFallada-1]+3*barraFallada.getImpedanciaFalla());
