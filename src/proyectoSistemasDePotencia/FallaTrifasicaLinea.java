...
public class FallaTrifasicaLinea {
	...
	public FallaTrifasicaLinea(double[][] zBarra,Lineas elementoFallado,ArrayList<Barras> barras,ArrayList<Lineas> lineas,ArrayList<Transformador> trafo,ArrayList<Generadores> generador) {
		...
		double [][]zBarrafinal = crz.inserccionEntreBarras(matrizInserccionEntreDosBarras, barras.indexOf(elementoFallado.getBarra1()), barras.indexOf(elementoFallado.getBarra2()));
...
public void setVectorVoltajesFalla() {
		...
		for(int i=0;i<zBarra.length-1;i++) {
			 ...
			 double elemento=barras.get(i+1).getVoltajePrefalla()-(zBarra[i][zBarra.length-1]/(zBarra[zBarra.length-1][zBarra.length-1]+elementoFallado.getImpedanciaFalla()))*barras.get(i+1).getVoltajePrefalla();
	...
	public void setCorrienteFallaElementoFallado(){
		...
		corrientePuntoFalla=(-1)*elementoFallado.getTensionLineaPuntoFalla()/(zBarra[zBarra.length-1][zBarra.length-1]+elementoFallado.getImpedanciaFalla());
