...
//suma de dos números complejos
 ...
 public static Complejo polar2Cartesiano(double magnitud,double angulo) {
	 
	 double real=magnitud*(Math.cos(angulo*Math.PI/180));
	 double imag=magnitud*(Math.sin(angulo*Math.PI/180));
