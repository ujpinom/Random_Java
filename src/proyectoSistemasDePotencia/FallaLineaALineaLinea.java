...
public class FallaLineaALineaLinea {
	...
	public FallaLineaALineaLinea(double[][] matrizSecuencia1,double[][] matrizSecuencia2,ArrayList<Barras> barras,ArrayList<Lineas> lineas,ArrayList<Transformador> trafo,
	...
	public void calculoCorrientePuntoFalla() {
		...
		double impedanciaTotal=matrizSecuencia1[matrizSecuencia1.length-1][matrizSecuencia1.length-1]+matrizSecuencia2[matrizSecuencia2.length-1][matrizSecuencia2.length-1]+3*elementoFallado.getImpedanciaFalla();
		
		try {
			corrientePuntoFalla1=Complejo.cociente(new Complejo(elementoFallado.getTensionLineaPuntoFalla(),0),new Complejo(0,impedanciaTotal));
	...
	public void vectoresVoltaje() {
		...
		vA1Imaginario=  Complejo.resta(new Complejo(elementoFallado.getTensionLineaPuntoFalla(),0),Complejo.producto(new Complejo(0,matrizSecuencia1[matrizSecuencia1.length-1][matrizSecuencia1.length-1]),corrientePuntoFalla1));
		
		vA2Imaginario=Complejo.producto(new Complejo(-1,0), Complejo.producto(new Complejo(0,matrizSecuencia2[matrizSecuencia1.length-1][matrizSecuencia1.length-1]),corrientePuntoFalla2));
